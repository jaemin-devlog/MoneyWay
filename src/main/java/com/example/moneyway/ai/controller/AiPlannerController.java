...
public class AiPlannerController {
     ...
     */
    @PostMapping("/planner")
    public ResponseEntity<List<GPTDayPlanDto>> getPlan(@RequestBody TravelPlanRequestDto request) {
        List<GPTDayPlanDto> recommendedPlan = aiPlannerService.getRecommendedPlan(request);
